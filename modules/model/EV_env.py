...
class EnhancedEVChargingEnv:
    ...
    def _get_state(self):
        ...
        Ahora incluye características avanzadas.
        """
        ...
        if self.has_willingness_info:
            willingness_normalized = self.willingness_to_pay[ev_id] / 1.5  # Asumiendo max 1.5
        ...
        if self.has_charge_rate_info:
            min_rate_normalized = self.min_charge_rate[ev_id] / 50.0  # Normalizado a 50kW
            max_rate_normalized = self.max_charge_rate[ev_id] / 350.0  # Normalizado a 350kW
        ...
        # -- Cálculo de características del entorno --
    ...
    def _get_possible_actions(self, state):
        ...
        considerando compatibilidad y restricciones avanzadas.
        OPTIMIZADO: Reduce el número de acciones para acelerar entrenamiento.
        """
        if state is None:
            return []
        ...
        # OPTIMIZACION: Limitar a máximo 3 spots para reducir complejidad
        ...
        for spot in spots_to_try:
            # OPTIMIZACION: Solo 3 niveles de potencia en lugar de muchos
            power_levels = []
