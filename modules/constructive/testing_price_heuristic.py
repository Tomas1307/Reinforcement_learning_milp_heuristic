...
from .price_heuristic import HeuristicaPorPrecio
...
def test_heuristica_precio(json_path):
    """
    Prueba la heurística basada en precio y muestra los resultados.
    ...
    # Inicializar la heurística por precio
    heuristica = HeuristicaPorPrecio(config)
    ...
    print("\nEstadísticas de la solución (Heurística por Precio):")
    ...
    plt.savefig("heuristica_precio_gantt.png", dpi=300, bbox_inches='tight')
    print("Gráfico de Gantt guardado como 'heuristica_precio_gantt.png'")
    plt.show()
...
if __name__ == "__main__":
    ...
    test_heuristica_precio(json_path)