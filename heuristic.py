...
from k_means_heuristic import modify_heuristic_with_best_params
...
class HeuristicaConstructivaEVs: 
    ...
    def _consolidar_sesiones_carga(self):
        ...
        """
        print("Fase de consolidación: rellenando huecos en sesiones de carga...")
        ...
        print(f"Consolidación completada: {cambios_realizados} nuevas asignaciones realizadas")
