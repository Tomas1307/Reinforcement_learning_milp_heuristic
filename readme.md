...
Este programa analiza automáticamente los resultados de optimización de hiperparámetros guardados en el directorio `hyperparameter/hyperparameter_results_constructive/` y genera las siguientes visualizaciones:
...
- `--output_dir`: Directorio para resultados (default: hyperparameter/hyperparameter_results_constructive)
