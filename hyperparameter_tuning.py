...
from heuristic import load_data, HeuristicaConstructivaEVs, save_schedule_to_json
...
class HyperparameterTuner:
    ...
    def __init__(self, config_paths, output_dir="hyperparameter_results", n_trials=10):
        """
...
def main():
    ...
    search_parser.add_argument("--output_dir", type=str, default="hyperparameter_results", 
    ...
    if args.command == "interactive" or args.command is None:
        ...
        data_dir = "./cluster_results/representative_files"  # Directorio con los archivos JSON
        ...
        # Configurar el tuner
        output_dir = input("Directorio de salida (default: hyperparameter_results): ").strip()
        if not output_dir:
...
def run_with_best_parameters(json_path, params_path, output_path=None):
    ...
    try:
        ...
        from heuristic import plot_charging_schedule
        ...
        from heuristic import plot_parking_schedule
        ...
        from heuristic import plot_cost_evolution
